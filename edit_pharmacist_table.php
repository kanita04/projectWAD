...
<head>
<title>Edit Pharmacist registration table</title>
    <meta charset="UTF-8" />
...
<table>
        ...
        if ($_SERVER["REQUEST_METHOD"] === "POST") {
            if (isset($_POST["update"])) {
                ...
                $updateQuery = "UPDATE Pharmacist SET fname='$firstName', lname='$lastName', DOB='$dob', gender='$gender', email='$email', phone='$phone' WHERE Pharmacist_ID='$pharmacistID'";
        ...
        $sql = "SELECT Pharmacist_ID, fname, lname, DOB, gender, email, phone FROM Pharmacist";
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<input type='hidden' name='pharmacist_id' class='action-input' value='" . $row["Pharmacist_ID"] . "'>";
