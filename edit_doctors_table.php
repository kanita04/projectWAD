...
<table>
        ...
        if ($_SERVER["REQUEST_METHOD"] === "POST") {
            if (isset($_POST["update"])) {
                ...
                $updateQuery = "UPDATE Doctor SET fname='$firstName', lname='$lastName', DOB='$dob', gender='$gender', email='$email', phone='$phone', years_of_experience='$experience' WHERE Doctor_ID='$doctorID'";
                $conn->query($updateQuery);
            } elseif (isset($_POST["delete"])) {
                // Delete operation
                $doctorID = $_POST["doctor_id"];

                $deleteQuery = "DELETE FROM Doctor WHERE Doctor_ID='$doctorID'";
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<input type='hidden' name='doctor_id' class='action-input' value='" . $row["Doctor_ID"] . "'>";
                ...
                echo "<input type='text' name='experience' class='action-input' value='" . $row["years_of_experience"] . "'>";
