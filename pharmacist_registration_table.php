...
<head>
    <title>Pharmacist registration table</title>
    <meta charset="UTF-8" />
...
<div class="table">
    <table>
        ...
        if ($result -> num_rows > 0){
            while($row = $result -> fetch_assoc()){
                echo "<tr><td>". $row["Pharmacist_ID"] . "</td><td>" . $row["fname"] . "</td><td>" . $row["lname"] . "</td><td>" . $row["DOB"] . "</td><td>". $row["gender"] . "</td><td>" . $row["email"] . "</td><td>" . $row["phone"] . "</td></tr>";
            }
            echo "</table>";
        }
        else{
    ...
    <a href="edit_pharmacist_table.php"><button type="button">Edit data</button></a>
</div>    
