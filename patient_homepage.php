...
<div class="container mt-5">
  <div class="row">
      ...
      <section class="homepage" id="homepage">
        <div class="content text-center text-md-left">
          ...
          <div class="directions">
                <a href="patient_schedule_appointment.php"><button type="button">Schedule an
                appointment</button></a>
                <a href="patient_view_appointments.php"><button type="button">View appointments</button></a>
                <a href="patient_view_prescriptions.php"><button type="button">View prescriptions</button></a>
    ...
    <div class="col-md-6">
      <div class="patient-background-image"></div>
    </div>
  </div>
</div>
