...
<head>
<title>Edit Patient registration table</title>
    <meta charset="UTF-8" />
...
<table>
        ...
        if ($_SERVER["REQUEST_METHOD"] === "POST") {
            if (isset($_POST["update"])) {
                ...
                $updateQuery = "UPDATE Patient SET fname='$firstName', lname='$lastName', DOB='$dob', gender='$gender', email='$email', phone='$phone' WHERE Patient_ID='$patientID'";
        ...
        $sql = "SELECT Patient_ID, fname, lname, DOB, gender, email, phone FROM Patient";
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<input type='hidden' name='patient_id' class='action-input' value='" . $row["Patient_ID"] . "'>";
